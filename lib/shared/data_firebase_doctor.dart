...
class GetDataFirebaseDoctor extends StatefulWidget {
  final String documentId;

  GetDataFirebaseDoctor({required this.documentId});

  @override
  State<GetDataFirebaseDoctor> createState() => _GetDataFirebaseDoctorState();
}

class _GetDataFirebaseDoctorState extends State<GetDataFirebaseDoctor> {
  File? _imageFile;
  ...
  Future<void> _uploadImage() async {
    try {
      ...
      final storageRef =
          FirebaseStorage.instance.ref("Certificate/$_uploadedImageUrl");
