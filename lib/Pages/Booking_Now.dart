...
class _BookingPageState extends State<BookingPage> {
                            ...
                            child: timedate.contains(_focusDay
                                ...
                                : GestureDetector(
                                    onTap: () {
                                      ...
                                      // print(timedate.contains(_focusDay
                                      //         .toString()
                                      //         .split(' ')[0] +
                                      //     "-${index + 5}:00 ${index + 5 > 11 ? "AM" : "PM"}"));

                                      // print(_focusDay.toString().split(' ')[0] +
                                      //     "-${index + 5}:00 ${index + 5 > 11 ? "AM" : "PM"}");
                                      // print(timedate);
                                    },
                                    child: Container(
                  ...
                  child: ElevatedButton(
                    onPressed: time == ''|| __value ==''
                        ...
                        : () {
                            ...
                            databaseRef
                                .child("71oDwcR8BGZhyqqB30LH65zeY3w2")
                                .push()
                                .set({
  ...
  getAllAppointment() {
    DatabaseReference starCountRef =
        FirebaseDatabase.instance.ref("71oDwcR8BGZhyqqB30LH65zeY3w2");
